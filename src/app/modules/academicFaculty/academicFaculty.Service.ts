...
const insertIntoDBFromEvent = async (
  e: AcademicFacultyCreatedEvents
): Promise<void> => {
...
const updateIntoDBFromEvent = async (e: AcademicFacultyUpdatedEvents) => {
...
const deleteOneFrmIntoEvent = async (syncId: string) => {
